...
def prep_val(f_seq, exp_seq, scratch_dict):
    ...
    for sample_val in val_sample:
        ...
        roi_file = sample_val + '_roi.png' #mask (yellow)
        roi = misc.imread(os.path.join(bm_dict, roi_file)) / 255
        img_file = sample_val + '_img.png' #base, original image
        seg_file = sample_val + '_seg.png' #traced layers
